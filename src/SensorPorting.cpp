...
/*TO DO Platform edits for Linux ->
 * change i2c address to TOF sensor 0x^^
 * get timing for platofrm delauy include "usleep
 * get fileread for i2c
 * check udev
 * add thread
 * lrwxrwxrwx 1 root root 5 Jan 23 15:19 /dev/apalis-i2c1 -> i2c-4
 *
 *
 */
